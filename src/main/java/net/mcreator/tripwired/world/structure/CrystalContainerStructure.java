...
package net.mcreator.tripwired.world.structure;
...
public class CrystalContainerStructure extends TripwiredModElements.ModElement {
	public CrystalContainerStructure(TripwiredModElements instance) {
		super(instance, 235);
	}
