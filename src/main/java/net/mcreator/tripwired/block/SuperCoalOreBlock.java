...
public class SuperCoalOreBlock extends TripwiredModElements.ModElement {
	@ObjectHolder("tripwired:super_coal_ore")
	public static final Block block = null;
	public SuperCoalOreBlock(TripwiredModElements instance) {
		super(instance, 289);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(SuperOresItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("super_coal_ore");
		}
	}
	@Override
