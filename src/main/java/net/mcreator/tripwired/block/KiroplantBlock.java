...
public class KiroplantBlock extends TripwiredModElements.ModElement {
	@ObjectHolder("tripwired:kiroplant")
	public static final Block block = null;
	public KiroplantBlock(TripwiredModElements instance) {
		super(instance, 273);
	}
