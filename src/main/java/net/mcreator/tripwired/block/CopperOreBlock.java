...
public class CopperOreBlock extends TripwiredModElements.ModElement {
	@ObjectHolder("tripwired:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(TripwiredModElements instance) {
		super(instance, 239);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 16)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(1, 0, 0, 64))));
		}
	}
}
