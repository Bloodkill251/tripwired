...
public class KiroGrassBlock extends TripwiredModElements.ModElement {
	@ObjectHolder("tripwired:kiro_grass")
	public static final Block block = null;
	public KiroGrassBlock(TripwiredModElements instance) {
		super(instance, 197);
	}
