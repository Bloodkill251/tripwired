...
public class KiroPlanksBlock extends TripwiredModElements.ModElement {
	@ObjectHolder("tripwired:kiro_planks")
	public static final Block block = null;
	public KiroPlanksBlock(TripwiredModElements instance) {
		super(instance, 220);
	}
