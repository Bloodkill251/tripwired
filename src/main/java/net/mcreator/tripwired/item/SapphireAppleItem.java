...
import net.mcreator.tripwired.procedures.SapphireAppleFoodEatenProcedure;
...
public class SapphireAppleItem extends TripwiredModElements.ModElement {
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			double z = entity.getPosZ();
			{
				...
				SapphireAppleFoodEatenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
