...
public class IronStickItem extends TripwiredModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(OtherModItemsItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON));
